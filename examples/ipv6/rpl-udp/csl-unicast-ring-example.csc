...
<simconf>
  ...
  <simulation>
    <title>TCP-powertrace-cslmac</title>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>49.80337011955235</x>
        <y>50.23653140526621</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
...
outputs = new Object();
TIMEOUT(300000);
//var dirpath = "$HOME/Contiki_source/contiki/tools/cooja/SimulationMotes/";
//var file = fopen(dirpath); 
//var output = new FileWriter("result.txt");
//if(!output){
...
//        outputs[id.toString()] = new FileWriter(dirpath+"log_"+id+".txt");
//        }
    
    WAIT_UNTIL(msg.match(/radio [0-9]*\.?[0-9]+%/gi));
   log.log(time + ":" + id + ":" + msg + "\n");
//   outputs[id.toString()].wirte(time + ":" + id + ":" + msg + "\n")
//;   //file.write(time + ":" + id + ":" + msg + "\n");
//try{
     YIELD();
//    }catch(e){
